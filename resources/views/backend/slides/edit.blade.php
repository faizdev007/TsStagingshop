...
<div class="row current_url" data-url="{{admin_url('slides')}}">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel pw">
            <div class="x_title">
                <h2></h2>
                <ul class="nav navbar-right panel_toolbox">
                  <li class="top-button"><a href="{{admin_url('slides')}}" class="btn btn-small btn-primary">View Slides</a></li>
                </ul>
