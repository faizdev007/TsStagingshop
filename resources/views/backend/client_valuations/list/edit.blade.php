...
@section('admin-content')
    ...
    <form method="post" action="{{admin_url('market-valuation/why-list/edit/'.$item->id)}}" data-toggle="validator">
                    ...
                    <div class="row current_url" data-url="{{admin_url('market-valuation')}}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" class="form-control" value="{{old('title',$item->title)}}" placeholder="Title" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="icon" name="icon" value="{{old('icon',$item->icon)}}" class="form-control icon-picker" required>
                            </div>
                        </div>
