            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="wrapper">
                ...
                <tr>
                    <td class="black" valign="top">
                        ...
                        <p style="font-family:Arial, sans-serif;font-size:16px;line-height:18px;color:#333333;">We thought we would provide you an update on your shortlisted properties :</p>
                    </td>
                </tr>
                <tr>
    ...
    <tr>
        ...
        <td class="pad_side">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="wrapper">
                <tr>
                    <td class="black" valign="top">
                        <p style="font-family:Arial, sans-serif;font-size:16px;line-height:18px;color:#333333;">We think you may also be interested in the properties below :</p>
                    </td>
                </tr>
                <tr>
                    <td height="25" style="line-height:1px;font-size:1px;"  class="fix_height">&nbsp;</td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="wrapper">
                ...
                <tr>
                    <td>
                        ...
                        @if( settings('email') )
                            <p style="font-family:Arial, sans-serif;font-size:16px;line-height:18px;color:#333333;"><strong>E-Mail:</strong> <a href="mailto:{{ settings('email') }}" aria-label="Email {{ settings('email') }}">{{ settings('email') }}</a></p>
                        @endif
                        @if( settings('telephone') )
