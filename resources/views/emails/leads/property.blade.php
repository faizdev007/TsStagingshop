            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="wrapper">
                ...
                <tr>
                    <td class="black" valign="top">
                        ...
                        <p style="font-family:Arial, sans-serif;font-size:16px;line-height:18px;color:#333333;">We think you may be interested in the properties below :</p>
                    </td>
                </tr>
                <tr>
                ...
                <table width="300" border="0" cellspacing="0" cellpadding="0" align="left" class="wrapper" style="height: 380px;">
                    <tr>
                        <td align="center" valign="top">
                            <table width="300" border="0" cellspacing="0" cellpadding="0" align="center" class="wrapper">
                                <tr>
                                    <td width="35" class="hide">&nbsp;</td>
                                        <td valign="top">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                                            <tr>
                                                <td align="center" valign="top"><a target="_blank" href="<?=$property->url;?>"><img src="{{ $property->primary_photo }}" width="250" height="180" alt="img_265X130" style="display:block;border:none; max-width:250px;" /></a></td>
                                            </tr>
                                            <tr>
