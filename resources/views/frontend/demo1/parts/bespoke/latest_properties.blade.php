                    ...
                    <div class="w-100">
                        <div class="row">
                            <div class="col-lg-6 col-sm-12 order-md-first order-lg-first order-last">
                                <strong class="f-20 u-block">{{ $property->details_headline }}, {{ $property->FsAddress2 }}</strong>
                                <span class="f-13 f-bold c-secondary text-uppercase u-block">{!! $property->display_price !!}</span>
                            ...
                            <div class="col-lg-6 col-sm-12 order-md-last order-lg-last order-first">
                                @foreach( $property->propertyMediaPhotos->take(1) as $media )
                                    <a href="{{ $property->url }}">
                                        <img src="{{ $media->photo_display }}" class="card-img" alt="{{ $property->search_headline }}">
                                    </a>
                                @endforeach
                            </div>
                        </div><!-- /.row -->
